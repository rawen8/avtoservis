        ...
        <div id="iteminfo" class="row">
            <div class="row2">
                ...
                <div class="col-md-7 col-sm-12">
                    ...
                    <div class="row orderinfo"> <!--row с опциями выбора и кол. наличия-->
                        <!-- ОПЦИИ / НАЛИЧИЕ-->
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="tabs">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="hidden-xs" role="presentation"><a href="#messages" id="commentLoad"
                                                                 data-uid="@productUid@"
                                                                 aria-controls="messages" role="tab" data-toggle="tab">Отзывы</a>
                    </li>
                    <li id="filesTab" class="hide hidden-xs" role="presentation"><a href="#files" aria-controls="files"
                                                                                    role="tab" data-toggle="tab"><span
                                    class="glyphicon glyphicon-cloud-download"></span>Файлы</a></li>
                    <li id="pagesTab" class="hidden-xs" role="presentation"><a href="#pages" aria-controls="pages"
                                                                               role="tab" data-toggle="tab">Статьи</a>
                    </li>
                        ...
                        <div id='addComment' class="well well-sm" style='display:none;margin-top:30px;'>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <button role="button" class="btn btn-info btn-sm pull-right"
                                        onclick="commentList('@productUid@', 'add', 1);">Проголосовать</span></button>
                            </div>
