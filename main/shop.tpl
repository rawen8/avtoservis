...
<head>
    ...
    <!-- UI -->
    <link href="@php echo $GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin']; php@css/jquery-ui.min.css"
          rel="stylesheet"/>
...
<body role="document" id="body" source="@NavActive@">
<div class="page-wrap">
            ...
            <div class="col-md-3 sidebar col-xs-3 hidden-xs visible-lg visible-md">
                ...
                <div class="panel panel-info" id="faset-filter">
                    <div class="panel-heading">
                        <span class="pull-right"><a href="?" id="faset-filter-reset" data-toggle="tooltip"
                                                    data-placement="top" title="Сбросить фильтр"><span
                                        class="glyphicon glyphicon-remove"></span>сброс</a></span>
                            ...
                            <form method="get" id="price-filter-form">
                                <div class="row">
                                    <div class="col-md-6" id="price-filter-val-min">
                                        от <input type="text" class="form-control input-sm" name="min"
                                                  value="@price_min@">
                                    </div>
                                    <div class="col-md-6" id="price-filter-val-max">
                                        до <input type="text" class="form-control input-sm" name="max"
                                                  value="@price_max@">
                                    </div>
                                </div>
                            </form>
